...
void WasAPIIF::setExclusive(bool flag)
{
	m_exclusiveAccess = flag;
	if(!m_instance.isNull())
	{
		m_instance->signalExclusiveUpdated();
	}
}

//-------------------------------------------------------------------------------------------

void WasAPIIF::signalExclusiveUpdated()
{
	emit exclusiveUpdated();
}
