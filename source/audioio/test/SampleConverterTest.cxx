...
void testInt24A32Convertion(tint noBits, tint bytesPerSample, bool littleEndian,
	bool alignHigh, bool isSigned, const tubyte *expect)
{
	const int c_noSamples = 10;
	const int c_noChannels = 2;
...
void testInt16Then24A32Convertion(tint noBits, tint bytesPerSample, bool littleEndian,
	bool alignHigh, bool isSigned, const tubyte *expect16, const tubyte *expect24A32)
{
	testInt16Convertion(noBits, bytesPerSample, littleEndian, alignHigh, isSigned, expect16);
	testInt24A32Convertion(noBits, bytesPerSample, littleEndian, alignHigh, isSigned, expect24A32);
}

//-------------------------------------------------------------------------------------------

TEST(SampleConverter,int16A24A32SamplesTo16BitSampleIn8BitsLSB)
{
	const tint c_noBits = 16;
	const tint c_bytesPerSample = 1;
	const bool c_littleEndian = true;
...
TEST(SampleConverter,int16A24A32SamplesTo16BitSampleIn8BitsMSB)
{
	const tint c_noBits = 16;
	const tint c_bytesPerSample = 1;
	const bool c_littleEndian = true;
