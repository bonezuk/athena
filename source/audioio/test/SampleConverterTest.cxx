...
TEST(SampleConverter,volumeForInt16)
{
	...
	EXPECT_EQ(0, memcmp(c_expectOutput16_75Percent, out, outputSize));

	memset(out, 0, outputSize);
	sampleConverter.setVolume(0.5);
	sampleConverter.convert(reinterpret_cast<const sample_t *>(c_int16Samples), out, 10, engine::e_SampleInt16);
	EXPECT_EQ(0, memcmp(c_expectOutput16_50Percent, out, outputSize));

	memset(out, 0, outputSize);
	sampleConverter.setVolume(0.25);
	sampleConverter.convert(reinterpret_cast<const sample_t *>(c_int16Samples), out, 10, engine::e_SampleInt16);
	EXPECT_EQ(0, memcmp(c_expectOutput16_25Percent, out, outputSize));
}
...
/*
	...
	0x040000000 (1073741824) * 0x9999999a (-1717986918) = 0xE6666666 80000000 = 0xE6666666
