	...
	bool alignHigh, bool isSigned, const tubyte *expect)
{
	...
	memset(out, 0 , outputSize);
	sampleConverter.convert(reinterpret_cast<const sample_t *>(c_int16Samples), out, c_noSamples, engine::e_SampleInt24);
	EXPECT_EQ(0, memcmp(expect, out, outputSize));

	memset(out, 0 , outputSize);
	sampleConverter.convert(reinterpret_cast<const sample_t *>(c_int16Samples), out, c_noSamples, engine::e_SampleInt32);
	EXPECT_EQ(0, memcmp(expect, out, outputSize));	
...
// 0x1999 ->   0x20,   0x20,  0x20 0x00,  0x00 0x20,  0x00 0x20,  0x20 0x00,
...
// 0x20 0x00 0x00,  0x00 0x00 0x20,  0x00 0x00 0x20,  0x20 0x00 0x00,
...
// 0x20 0x00 0x00 0x00,  0x00 0x00 0x00 0x20,  0x00 0x00 0x00 0x20,  0x20 0x00 0x00 0x00,
...
// 0x1999 ->   0x20 + 0x80 = 0xa0,   0xa0,  0xa0 0x00,  0x00 0xa0,  0x00 0xa0,  0xa0 0x00,
...
// 0xa0 0x00 0x00,  0x00 0x00 0xa0,  0x00 0x00 0xa0,  0xa0 0x00 0x00,
// 0x66 0x00 0x00,  0x00 0x00 0x66,  0x00 0x00 0x66,  0x66 0x00 0x00,
// 0x4d 0x00 0x00,  0x00 0x00 0x4d,  0x00 0x00 0x4d,  0x4d 0x00 0x00,
// 0x33 0x00 0x00,  0x00 0x00 0x33,  0x00 0x00 0x33,  0x33 0x00 0x00,
...
// 0xa0 0x00 0x00 0x00,  0x00 0x00 0x00 0xa0,  0x00 0x00 0x00 0xa0,  0xa0 0x00 0x00 0x00,
// 0x66 0x00 0x00 0x00,  0x00 0x00 0x00 0x66,  0x00 0x00 0x00 0x66,  0x66 0x00 0x00 0x00,
// 0x4d 0x00 0x00 0x00,  0x00 0x00 0x00 0x4d,  0x00 0x00 0x00 0x4d,  0x4d 0x00 0x00 0x00,
// 0x33 0x00 0x00 0x00,  0x00 0x00 0x00 0x33,  0x00 0x00 0x00 0x33,  0x33 0x00 0x00 0x00,
