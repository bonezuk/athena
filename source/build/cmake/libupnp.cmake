...
if (${TIGER_LINUX_DISTRO})
	...
	if (OMEGA_MSVC16 OR OMEGA_IS_MACOSX_ARM)
		set(LIBUPNP_VERSION "1.14.12")
	else (OMEGA_MSVC16 OR OMEGA_IS_MACOSX_ARM)
		set(LIBUPNP_VERSION "1.6.25")
	endif (OMEGA_MSVC16 OR OMEGA_IS_MACOSX_ARM)
	...
	if (NOT OMEGA_MSVC16 AND NOT OMEGA_IS_MACOSX_ARM)
	...
	endif (NOT OMEGA_MSVC16 AND NOT OMEGA_IS_MACOSX_ARM)
	...
	if (OMEGA_WIN32)
		...
		if (LIBUPNP_VERSION STREQUAL "1.6.25")
			set ( LIBUPNP_LIBRARIES ixml libupnp threadutil )
		else (LIBUPNP_VERSION STREQUAL "1.6.25")
			set ( LIBUPNP_LIBRARIES ixml libupnp )
		endif (LIBUPNP_VERSION STREQUAL "1.6.25")
	endif (OMEGA_WIN32)
