...
!define ORCUSPATH "..\..\install\WIN32.OPT.VC9\orcus"
...
section  "Black Omega" SecDummy
	...
	file "${ORCUSPATH}\bin\Microsoft.VC90.CRT\Microsoft.VC90.CRT.manifest"
	file "${ORCUSPATH}\bin\Microsoft.VC90.CRT\msvcm90.dll"
	file "${ORCUSPATH}\bin\Microsoft.VC90.CRT\msvcp90.dll"
	file "${ORCUSPATH}\bin\Microsoft.VC90.CRT\msvcr90.dll"
	...
	file "${ORCUSPATH}\bin\network.dll"
	file "${ORCUSPATH}\bin\PThreadVS2.dll"
	...
	file "${ORCUSPATH}\bin\track_db.dll"
	file "${ORCUSPATH}\bin\track_info.dll"
	file "${ORCUSPATH}\bin\track_model.dll"
